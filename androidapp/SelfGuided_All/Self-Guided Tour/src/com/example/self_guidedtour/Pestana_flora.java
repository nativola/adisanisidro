...
/**
 * Class that contains the flora object info, like add objects, and
 * her corresponding childrens or properties.
 * 
 * Calls the fragment or UI pestana_flora.xml inside main_tabs
 * */
public class Pestana_flora extends SherlockActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pestana_flora);
		  ...
		  mExpandableList = (ExpandableListView)findViewById(R.id.expandable_list);
	        ...
	        if(Intro_Screen.MARCADOR.equals("Stage 1: Coco Loco >>")) {
	        	if(db != null){	 
	 	        	Cursor c= db.rawQuery("SELECT nombre, nombreCientif, info FROM Flora WHERE punto=1", null);
	 	        	if(c.moveToFirst()) {
	 	        		do {
	        ...
	        if(Intro_Screen.MARCADOR.equals("Stage 2: Trapiche >>")) {
	        	if(db != null){	 
	 	        	Cursor c= db.rawQuery("SELECT nombre,nombreCientif, info FROM Flora WHERE punto=2", null);
	 	        	if(c.moveToFirst()) {
	 	        		do {
	 	        			Parent parent = new Parent();
	 	                    parent.setTitle(c.getString(0)); 
	        ...
	        if(Intro_Screen.MARCADOR.equals("Stage 3: Platas Ornamentales >>")) {
	        	if(db != null){	 
	 	        	Cursor c= db.rawQuery("SELECT nombre,nombreCientif, info FROM Flora WHERE punto=3", null);
	 	        	if(c.moveToFirst()) {
	 	        		do {
	 	        			Parent parent = new Parent();
	 	                    parent.setTitle(c.getString(0)); 
	        ...
	        if(Intro_Screen.MARCADOR.equals("Check out: Guarumo Tree >>")) {
	        	if(db != null){	 
	 	        	Cursor c= db.rawQuery("SELECT nombre,nombreCientif, info FROM Flora WHERE punto=10", null);
	 	        	if(c.moveToFirst()) {
	 	        		do {
	 	        			Parent parent = new Parent();
	 	                    parent.setTitle(c.getString(0)); 
	        ...
	        if(Intro_Screen.MARCADOR.equals("Stage 5: Colonia de Zompopas >>")) {
	        	if(db != null){	 
	 	        	Cursor c= db.rawQuery("SELECT nombre,nombreCientif, info FROM Flora WHERE punto=5", null);
	 	        	if(c.moveToFirst()) {
	 	        		do {
	 	        			Parent parent = new Parent();
	 	                    parent.setTitle(c.getString(0)); 
	        ...
	        if(Intro_Screen.MARCADOR.equals("Stage 6: Medición de Aguas >>")) {
	        	if(db != null){	 
	 	        	Cursor c= db.rawQuery("SELECT nombre,nombreCientif, info FROM Flora WHERE punto=6s", null);
	 	        	if(c.moveToFirst()) {
	 	        		do {
	 	        			Parent parent = new Parent();
	 	                    parent.setTitle(c.getString(0)); 
	        ...
	        if(Intro_Screen.MARCADOR.equals("Stage 7: Humedal >>")) {
	        	if(db != null){	 
	 	        	Cursor c= db.rawQuery("SELECT nombre,nombreCientif, info FROM Flora WHERE punto=7", null);
	 	        	if(c.moveToFirst()) {
	 	        		do {
	 	        			Parent parent = new Parent();
	 	                    parent.setTitle(c.getString(0)); 
	        ...
	        if(Intro_Screen.MARCADOR.equals("Stage 8: Árbol de Almendro >>")) {
	        	if(db != null){	 
	 	        	Cursor c= db.rawQuery("SELECT nombre,nombreCientif, info FROM Flora WHERE punto=8", null);
	 	        	if(c.moveToFirst()) {
	 	        		do {
	 	        			Parent parent = new Parent();
	 	                    parent.setTitle(c.getString(0)); 
	        ...
	        if(Intro_Screen.MARCADOR.equals("Stage 9: Árbol Fruta de Pan >>")) {
	        	if(db != null){	 
	 	        	Cursor c= db.rawQuery("SELECT nombre,nombreCientif, info FROM Flora WHERE punto=9", null);
	 	        	if(c.moveToFirst()) {
	 	        		do {
	 	        			Parent parent = new Parent();
	 	                    parent.setTitle(c.getString(0)); 
				...
				public boolean onChildClick(ExpandableListView parent, View v,
					...
					if(Intro_Screen.MARCADOR.equals("Stage 1: Coco Loco >>")) {
						if(childPosition==2) {
							db = usdbh.getWritableDatabase();
							if(db != null){	 
					        	Cursor c= db.rawQuery("SELECT moreinfo FROM Flora WHERE punto=1", null);
						...
						if(childPosition==2) {
							db = usdbh.getWritableDatabase();
							if(db != null){	 
					        	Cursor c= db.rawQuery("SELECT moreinfo FROM Flora WHERE punto=2", null);
					        	c.moveToPosition(groupPosition);
					        	Intro_Screen.id_item=groupPosition;
								Link_Activity.urls=c.getString(0);
					            db.close();
						...
						if(childPosition==2) {
							db = usdbh.getWritableDatabase();
							if(db != null){	 
					        	Cursor c= db.rawQuery("SELECT moreinfo FROM Flora WHERE punto=3", null);
					        	c.moveToPosition(groupPosition);
					        	Intro_Screen.id_item=groupPosition;
								Link_Activity.urls=c.getString(0);
					            db.close();
						...
						if(childPosition==2) {
							db = usdbh.getWritableDatabase();
							if(db != null){	 
					        	Cursor c= db.rawQuery("SELECT moreinfo FROM Flora WHERE punto=10", null);
					        	c.moveToPosition(groupPosition);
					        	Intro_Screen.id_item=groupPosition;
								Link_Activity.urls=c.getString(0);
					            db.close();
						...
						if(childPosition==2) {
							db = usdbh.getWritableDatabase();
							if(db != null){	 
					        	Cursor c= db.rawQuery("SELECT moreinfo FROM Flora WHERE punto=5", null);
					        	c.moveToPosition(groupPosition);
					        	Intro_Screen.id_item=groupPosition;
								Link_Activity.urls=c.getString(0);
					            db.close();
						...
						if(childPosition==2) {
							db = usdbh.getWritableDatabase();
							if(db != null){	 
					        	Cursor c= db.rawQuery("SELECT moreinfo FROM Flora WHERE punto=6", null);
					        	c.moveToPosition(groupPosition);
					        	Intro_Screen.id_item=groupPosition;
								Link_Activity.urls=c.getString(0);
					            db.close();
						...
						if(childPosition==2) {
							db = usdbh.getWritableDatabase();
							if(db != null){	 
					        	Cursor c= db.rawQuery("SELECT moreinfo FROM Flora WHERE punto=7", null);
					        	c.moveToPosition(groupPosition);
					        	Intro_Screen.id_item=groupPosition;
								Link_Activity.urls=c.getString(0);
					            db.close();
						...
						if(childPosition==2) {
							db = usdbh.getWritableDatabase();
							if(db != null){	 
					        	Cursor c= db.rawQuery("SELECT moreinfo FROM Flora WHERE punto=8", null);
					        	c.moveToPosition(groupPosition);
					        	Intro_Screen.id_item=groupPosition;
								Link_Activity.urls=c.getString(0);
					            db.close();
						...
						if(childPosition==2) {
							db = usdbh.getWritableDatabase();
							if(db != null){	 
					        	Cursor c= db.rawQuery("SELECT moreinfo FROM Flora WHERE punto=9", null);
					        	c.moveToPosition(groupPosition);
					        	Intro_Screen.id_item=groupPosition;
								Link_Activity.urls=c.getString(0);
					            db.close();
						...
						if(childPosition==2) {
							db = usdbh.getWritableDatabase();
							if(db != null){	 
					        	Cursor c= db.rawQuery("SELECT moreinfo FROM Flora WHERE punto=4", null);
					        	c.moveToPosition(groupPosition);
					        	Intro_Screen.id_item=groupPosition;
								Link_Activity.urls=c.getString(0);
					            db.close();
