(function() {
	tinymce.create('tinymce.plugins.kadicon', {
		init : function(ed, url) {
			// Register commands
			ed.addCommand('kadicon', function() {
				ed.windowManager.open({
					file : url + '/icon_popup.php', // file that contains HTML for our modal window
			...
			// Register buttons
			ed.addButton('kadicon_button', {title : 'Insert Icon', cmd : 'kadicon', image: url + '/img/cool.png' });
		},
