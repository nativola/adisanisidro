(function() {
	tinymce.create('tinymce.plugins.kadcolumns', {
		init : function(ed, url) {
			// Register commands
			var t = this;
			ed.addCommand('kadcolumns', function() {
				ed.windowManager.open({
					file : url + '/columns_popup.php', // file that contains HTML for our modal window
			...
			// Register buttons
			ed.addButton('kadcolumns_button', {title : 'Insert Columns', cmd : 'kadcolumns', image: url + '/img/columns.png' });
