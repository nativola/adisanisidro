...
<?php else : ?>
	...
	<form action="<?php echo esc_url( add_query_arg( 'address', $load_address, get_permalink( woocommerce_get_page_id('edit_address') ) ) ); ?>" method="post" class="woo_address_edit">
		...
		<p>
			<input type="submit" class="button kad-btn kad-btn-primary" name="save_address" value="<?php _e( 'Save Address', 'woocommerce' ); ?>" />
