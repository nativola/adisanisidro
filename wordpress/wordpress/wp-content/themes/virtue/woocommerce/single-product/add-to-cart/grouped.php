...
<form action="<?php echo esc_url( $product->add_to_cart_url() ); ?>" class="cart" method="post" enctype='multipart/form-data'>
		...
		<tbody>
			<?php foreach ( $grouped_products as $child_product ) : ?>
				<tr>
					...
					<td class="product_label"><label for="product-<?php echo $child_product['product']->id; ?>"><?php
					...
					<td class="product_price"><?php echo $child_product['product']->get_price_html(); ?>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="kad_add_to_cart kad-btn kad-btn-primary button alt"><?php echo apply_filters('single_add_to_cart_text', __( 'Add to cart', 'woocommerce' ), $product->product_type); ?></button>
